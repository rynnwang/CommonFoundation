using System.Text;
using Beyova.FunctionService.Generic;
...
namespace Beyova.FunctionService.Generic
{
    ...
    public abstract class BaseAuthenticationController<TEntity, TCriteria> : BaseGenericServiceController<TEntity, TCriteria>
        where TEntity : new()
    {
