...
namespace Beyova.FunctionService.Generic
{
        ...
        where TAuthenticationResult : IAuthenticationResult<TUserInfo, TFunctionalRole>
    {
        ...
        [ApiOperation(ApiResourceNames.SSOAuthorizationPartner, HttpConstants.HttpMethod.Put)]
        [ApiPermission(ApiPermissions.AuthenticationAdministrator)]
        ...
        [ApiOperation(ApiResourceNames.SSOAuthorizationPartner, HttpConstants.HttpMethod.Post)]
        ...
        [ApiOperation(ApiResourceNames.SSOTokenExchange, HttpConstants.HttpMethod.Put)]
        ...
        [ApiOperation(ApiResourceNames.SSOTokenExchange, HttpConstants.HttpMethod.Post)]
        ...
        /// <param name="request">The request.</param>
        /// <returns>TSSOAuthorization.</returns>
        [ApiOperation(ApiResourceNames.OAuth, HttpConstants.HttpMethod.Put)]
        ...
        /// <param name="authorization">The authorization.</param>
        /// <returns>TSSOAuthorization.</returns>
        [ApiOperation(ApiResourceNames.OAuth, HttpConstants.HttpMethod.Post, "Grant")]
        ...
        /// <param name="authorization">The authorization.</param>
        /// <returns>TSSOAuthorization.</returns>
        [ApiOperation(ApiResourceNames.OAuth, HttpConstants.HttpMethod.Post, "Verify")]
        ...
        /// <param name="criteria">The criteria.</param>
        /// <returns>TSSOAuthorization.</returns>
        [ApiOperation(ApiResourceNames.SSOAuthorization, HttpConstants.HttpMethod.Post)]
        [ApiPermission(ApiPermissions.AuthenticationAdministrator)]
