...
{
    /// <summary>
    /// Class ApiCacheAttribute. It would take effects when <see cref="Beyova.Api.RestApi.ApiOperationAttribute"/> take effects.
    /// </summary>
    ...
    public class ApiCacheAttribute : Attribute
    {
        ...
        /// The cache container.
        /// </value>
        public IApiCacheContainer CacheContainer { get; protected set; }
