...
namespace Beyova.Gravity
{
    ...
    public interface ICentralAuthenticationProtocol
    {
        ...
        [ApiOperation(GenericFunctionalServiceConstants.ResourceName.CentralAuthentication, HttpConstants.HttpMethod.Put, "Authenticate")]
        ...
        [ApiOperation(GenericFunctionalServiceConstants.ResourceName.CentralAuthentication, HttpConstants.HttpMethod.Delete, "DisposeSession")]
        ...
        [ApiOperation(GenericFunctionalServiceConstants.ResourceName.CentralAuthentication, HttpConstants.HttpMethod.Get, "GetSessionList")]
