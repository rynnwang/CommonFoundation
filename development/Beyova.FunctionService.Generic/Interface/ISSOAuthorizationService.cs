...
namespace Beyova.FunctionService.Generic
{
        ...
        where TAuthenticationResult : IAuthenticationResult<TUserInfo, TFunctionalRole>
    {
        ...
        [ApiOperation(GenericFunctionalServiceConstants.ResourceName.SSOAuthorizationPartner, HttpConstants.HttpMethod.Put)]
        [ApiPermission(GenericFunctionalServiceConstants.Permission.AuthenticationAdministrator)]
        ...
        [ApiOperation(GenericFunctionalServiceConstants.ResourceName.SSOAuthorizationPartner, HttpConstants.HttpMethod.Post)]
        ...
        [ApiOperation(GenericFunctionalServiceConstants.ResourceName.SSOTokenExchange, HttpConstants.HttpMethod.Put)]
        ...
        [ApiOperation(GenericFunctionalServiceConstants.ResourceName.SSOTokenExchange, HttpConstants.HttpMethod.Post)]
        ...
        /// <param name="request">The request.</param>
        /// <returns>TSSOAuthorization.</returns>
        [ApiOperation(GenericFunctionalServiceConstants.ResourceName.OAuth, HttpConstants.HttpMethod.Put)]
        ...
        /// <param name="authorization">The authorization.</param>
        /// <returns>TSSOAuthorization.</returns>
        [ApiOperation(GenericFunctionalServiceConstants.ResourceName.OAuth, HttpConstants.HttpMethod.Post, "Grant")]
        ...
        /// <param name="authorization">The authorization.</param>
        /// <returns>TSSOAuthorization.</returns>
        [ApiOperation(GenericFunctionalServiceConstants.ResourceName.OAuth, HttpConstants.HttpMethod.Post, "Verify")]
        ...
        /// <param name="criteria">The criteria.</param>
        /// <returns>TSSOAuthorization.</returns>
        [ApiOperation(GenericFunctionalServiceConstants.ResourceName.SSOAuthorization, HttpConstants.HttpMethod.Post)]
        [ApiPermission(GenericFunctionalServiceConstants.Permission.AuthenticationAdministrator)]
