...
namespace Beyova.FunctionService.Generic
{
        ...
        where TBinaryStorageCriteria : BinaryStorageMetaDataCriteria
    {
        ...
        [ApiOperation(GenericFunctionalServiceConstants.ResourceName.BinaryStorageCredential, HttpConstants.HttpMethod.Post, "Upload")]
        [TokenRequired(true)]
        ...
        /// <returns>BinaryStorageActionCredential.</returns>
        [ApiOperation(GenericFunctionalServiceConstants.ResourceName.BinaryStorageCredential, HttpConstants.HttpMethod.Post, "Download")]
        ...
        [ApiOperation(GenericFunctionalServiceConstants.ResourceName.BinaryStorage, HttpConstants.HttpMethod.Post, "User")]
        [TokenRequired(true)]
        ...
        /// <param name="criteria">The criteria.</param>
        /// <returns>List&lt;TBinaryStorageObject&gt;.</returns>
        [ApiOperation(GenericFunctionalServiceConstants.ResourceName.BinaryStorage, HttpConstants.HttpMethod.Post)]
        [TokenRequired(true)]
        [ApiPermission(GenericFunctionalServiceConstants.Permission.BinaryStorageDataAdministrator, ApiPermission.Required)]
        ...
        [ApiOperation(GenericFunctionalServiceConstants.ResourceName.BinaryStorage, HttpConstants.HttpMethod.Get)]
        ...
        /// <returns>List&lt;TBinaryStorageObject&gt;.</returns>
        [ApiOperation(GenericFunctionalServiceConstants.ResourceName.BinaryStorage, HttpConstants.HttpMethod.Post, "GetByBatch")]
        ...
        [ApiOperation(GenericFunctionalServiceConstants.ResourceName.BinaryStorage, HttpConstants.HttpMethod.Put)]
        [TokenRequired(true)]
        ...
        /// </summary>
        /// <param name="identifier">The identifier.</param>
        [ApiOperation(GenericFunctionalServiceConstants.ResourceName.BinaryStorage, HttpConstants.HttpMethod.Delete)]
        [TokenRequired(true)]
