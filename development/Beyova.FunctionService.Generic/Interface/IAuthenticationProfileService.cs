...
namespace Beyova.CommonServiceInterface
{
        ...
        where TFunctionalRole : struct, IConvertible
    {
        ...
        [ApiOperation(CommonServiceConstants.ResourceName.Token, HttpConstants.HttpMethod.Put)]
        ...
        [ApiOperation(CommonServiceConstants.ResourceName.Token, HttpConstants.HttpMethod.Delete)]
        ...
        /// TUserInfo.
        /// </returns>
        [ApiOperation(CommonServiceConstants.ResourceName.Token, HttpConstants.HttpMethod.Get)]
        ...
        /// LoginResult.
        /// </returns>
        [ApiOperation(CommonServiceConstants.ResourceName.Token, HttpConstants.HttpMethod.Post)]
        ...
        /// SessionInfo.
        /// </returns>
        [ApiOperation(CommonServiceConstants.ResourceName.SessionInfo, HttpConstants.HttpMethod.Get)]
        ...
        [ApiOperation(CommonServiceConstants.ResourceName.SessionInfo, HttpConstants.HttpMethod.Post)]
        [TokenRequired(true)]
        ...
        [ApiOperation(CommonServiceConstants.ResourceName.UserInfo, HttpConstants.HttpMethod.Post)]
        [TokenRequired(true)]
        ...
        [ApiOperation(CommonServiceConstants.ResourceName.UserInfo, HttpConstants.HttpMethod.Get)]
