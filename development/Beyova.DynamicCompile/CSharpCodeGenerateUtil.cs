...
namespace Beyova
{
    ...
    public static class CSharpCodeGenerateUtil
    {
        ...
        /// <returns></returns>
        public static string ReformatVariableName(string name)
        {
            if (!string.IsNullOrEmpty(name))
            {
                var result = nonVariableCharactor.Replace(name, string.Empty);
        ...
        /// <returns></returns>
        public static string GenerateUniqueTypeName(this Type type)
        {
            if (type != null)
            {
        ...
        public static void AppendBeginBrace(this StringBuilder builder, ref int indent)
        {
            if (builder != null)
            {
        ...
        public static void AppendEndBrace(this StringBuilder builder, ref int indent, bool appendStatementEnd = false)
        {
            if (builder != null)
            {
                indent--;
...
# endif
        ...
        /// <returns></returns>
        public static string CombineCode<T>(IEnumerable<T> items, Func<T, string> getCodePiece, int estimatedEachLength, char separator = StringConstants.CommaChar)
        {
        ...
        public static void WriteProgrammingIntelligenceFileDescription(StringBuilder builder)
        {
            if (builder != null)
            {
                ...
                builder.AppendLine("// https://github.com/rynnwang/CommonFoundation");
        ...
        #endregion Append Check statement
        ...
        #endregion AppendThrowExceptionStatement
    }
}