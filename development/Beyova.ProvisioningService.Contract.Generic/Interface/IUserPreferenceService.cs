...
namespace Beyova.FunctionService.Generic
{
           ...
           where TUserPreferenceCriteria : UserPreferenceCriteria
    {
        ...
        [ApiOperation(ApiResourceNames.Preference, HttpConstants.HttpMethod.Put)]
        [TokenRequired(true)]
        [ApiPermission(ApiPermissions.PreferenceAdministrator)]
        ...
        [ApiOperation(ApiResourceNames.Preference, HttpConstants.HttpMethod.Post)]
        [TokenRequired(true)]
        [ApiPermission(ApiPermissions.PreferenceAdministrator)]
        ...
        /// <param name="preference">The preference.</param>
        /// <returns>System.Nullable&lt;Guid&gt;.</returns>
        [ApiOperation(ApiResourceNames.UserPreference, HttpConstants.HttpMethod.Put)]
        [TokenRequired(true)]
        ...
        /// <param name="criteria">The criteria.</param>
        /// <returns>List&lt;TUserPreference&gt;.</returns>
        [ApiOperation(ApiResourceNames.UserPreference, HttpConstants.HttpMethod.Post)]
        [TokenRequired(true)]
